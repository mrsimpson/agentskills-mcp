...
describe('skills CLI', () => {
  describe('--help', () => {
    it('should display help message', () => {
      ...
      expect(output).toContain('Usage: npx @codemcp/skills <command> [options]');
  ...
  describe('no arguments', () => {
    it('should display banner', () => {
      ...
      expect(output).toContain('npx @codemcp/skills add');
      expect(output).toContain('npx @codemcp/skills check');
      expect(output).toContain('npx @codemcp/skills update');
      expect(output).toContain('npx @codemcp/skills init');
  ...
  describe('unknown command', () => {
    it('should show error for unknown command', () => {
      ...
      expect(output).toMatchInlineSnapshot(`
        ...
        Run npx @codemcp/skills --help for usage.
        "
      `);
    });
  });
